      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <svg width="56" height="56" viewBox="0 0 56 56" fill="none" style={{ margin: '0 auto 16px' }}>
            ...
            <path d="M19 17 L28 36 L37 17" stroke="#080c0f" stroke-width="4"
          ...
          <p style={{ color: '#5a7080', fontSize: '14px', marginTop: '6px' }}>
        ...
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: '14px' }}>
            <label style={{ display: 'block', fontSize: '12px', fontWeight: 600, color: '#8ba0ae', marginBottom: '6px', letterSpacing: '0.3px' }}>
              Email
            </label>
            <input
              type="email"
          ...
          <button
            ...
            style={{
              width: '100%',
              background: loading ? '#00a8be' : '#00C8E0',
              color: '#080c0f',
              border: 'none',
              borderRadius: '8px',
              padding: '12px',
